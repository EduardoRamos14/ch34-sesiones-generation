...
//indice del objeto de numero de canciones de 2020
console.log("Total de canciones por año 2020: " + cancionesPesoPluma[5]["2020"])
//Mostarr el total de canciones 
console.log("Todal de canciones: " + cancionesPesoPluma[5].total);



//conversion de datos (casting)

//conversdion implicita
console.log("Hola" + 34);//"hola ch 34"
...
console.log("$3 MxN" +5 + 6);//2MxN56
console.log(parseInt("$3 MxN") +5 + 6);//NaN
console.log(parseInt("$3 MxN".replace($, '')) + (5 + 6)); // Esto imprimirá 14
